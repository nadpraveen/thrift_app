...
// -->
    ...
    <body align="center">
        <form action="ann_stmt_pdf.php" method="post" style=" margin-left: 30%; margin-top: 5%;">
            <?php
            ...
            <table >
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select name="trans_date" required>
                            ...
                            <?php
                            $query = "SELECT TRANS_DATE_1 FROM th_members_ob_cb_data where EMP_NO1 = $user";
                ...
                <tr>
                    ...
                    <td><button><a href="reports.php" id="printing">close</a></button></td>
                </tr>
