...
$url = 'https://vspthrift.com/web_app_ver01/ann_statement.php?emp_no=' . $user . '&auth=' . $auth . '&fin_year=' . $fin_year . '&trans_date=' . $trans_date.'&type=pdf';
...
$file_name = $user . '_ann_report_' . $fin_year_for_file . '.pdf';


file_put_contents('reports/' . $file_name, $output);

header("location:ann_statement.php?auth=$auth&fin_year=$fin_year&trans_date=$trans_date&file=$file_name");
?>
