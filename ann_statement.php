<html>
    ...
    <body>
        <div class="col-md-12">
            ...
            $trans_date = trim($_GET['trans_date'], "'");
...
//            echo '<br>';
            ...
            foreach ($statement as $state) {
                ...
                <table class="table table-condensed">
                    <tr >
                        <td width="7%"><img src="data:image/png;base64, <?php echo $logo ?>" width="50" height="70" alt="logo" /></td>
                        <td  align="center" colspan="3">
                            <span style="font-size: large; text-align: center; font-weight: bold">Visakhapatnam Steel Plant Employees Co-op Thrift and Credit Society Ltd.</span>
                            <p>
                                <span align="center">(REGD.NO.B-1918)</span><br>
                                <span><b align="center">Ukkunagaram , VISAKHAPATNAM - 530032</b></span>						
                            </p>
                        </td>
                    </tr>
                </table>
                <div style="width:100%; align-content: right; text-align: right; margin-right:auto; margin-left: auto; margin-bottom: 5px; ">
                    Date : <?php echo date('d-M-Y'); ?> 
                </div>
                <table style="align-content: center; text-align: right; margin-right:auto; margin-left: auto; margin-bottom: 20px; ">
                    <tr>
                        <td>
                            <span style="background-color: #e5e5e5;font-size: medium;text-align: center;font-weight: bolder;margin-left: auto;margin-right: auto;display: block;">
                                ANNUAL STATEMENT FOR THE FINANCIAL YEAR : <?php echo $start_year . ' - ' . $close_year; ?>
                            </span>
                        </td>
                    </tr>
                </table>
                <table class="table table-bordered table-condensed info">
                    <tr>
                ...
                <table class="table-condensed dep_info">
                    <tr>
                        <th colspan="6">
                            <span style="font-size: medium; text-align: center">DEPOSITS</span>
                        </th>
                    </tr>
                </table>
                <table class="table-condensed dep_table data_tbl">
                    <tr>
                        <td class="dep_td"></td>
                ...
                <table class="table-condensed dep_info">
                    <tr>
                        <th colspan="6">
                            <span style="font-size: medium; text-align: center">LOANS</span>
                        </th>
                    </tr>
                </table>
                <table class="table table-condensed data_tbl">
                    <tr>
                        <th colspan="6" align="left" style="font-size: small">
                            Long Term Loan
                        </th>
                    </tr>
                    <tr>
                ...
                <table class=" table table-bordered table-condensed data_tbl sloan_info">
                    <tr>
                        <th colspan="6" align="left" style="font-size: small">
                            Medium Term Loan
                        </th>
            ...
            ?>
            <table class=" table table-bordered table-condensed dep_info">
                <tr>
                    <th colspan="6">
                        <span style="font-size: medium; text-align: center">TRANSACTION DETAILS</span>
                    </th>
                </tr>
            </table>
            <table class="table table-bordered table-condensed data_tbl">
                <tr>
                ...
                <tr>
                    <td style="padding: 10px;">
                        <span class="pull-left">
                            <a href="reports.php" id="printing" style=""><button>close</button></a>
                        </span>
                    </td>
                    <td>
                        <span class="pull-right">
                            <a href="<?php echo $file_name ?>" class="btn btn-warning"><button>Download</button></a>
                        </span>
                    </td>
                </tr>
            </table>
