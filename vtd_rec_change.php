...
if (isset($_POST['btn_change_vtd'])) {
    ...
    $present_vtd = $_POST['present_vtd'];
    $curr_date = date("d-M-Y");
    //$otp_code = $_POST['otp'];
    if ($new_vtd > 9900) {
        header("location:vtd.php?st=1");
        $error = 'Recovery Must be less thane Rs.9900/-';
    } elseif ($new_vtd % 100 != 0) {
        header("location:vtd.php?st=2");
...
<html>
    ...
    <tr >
        <td colspan="4">
            <p>Sir </p>
            <p style="text-indent: 3em"><strong>Sub:- Application for Enhancement/Reduction/Stoppage of Voluntary Thrift Deposit Recovery</strong></p>
        </td>
    </tr>
</table>
        ...
        <td>
            ...
            if ($new_vtd > 0) {
                ...
                <p style="text-indent: 2em">
                    Kindly enhance / reduce my Voluntary Thrift Deposit Recovery rate from <strong>Rs.<?php echo round($present_vtd, 0) ?>/-</strong> to <strong>Rs. <?php echo $new_vtd ?>/-</strong> from my salary w.e.f .............. <?php echo date('Y'); ?>
                </p>
                <?php
            } else if ($new_vtd == 0) {
                ?>
                <p style="text-indent: 3em">
                    Kindly stop deduction of my Voluntary Thrift Deposit of Rs. <strong>Rs.<?php echo round($present_vtd, 0) ?>/-</strong> from my salary w.e.f .............. <?php echo date('Y'); ?>
                </p>
                <?php
            }
            ?>
...
<div id="click" style=" width: 60%; margin-left: auto; margin-right: auto;">
    ...
    <p id="close_win" style="margin-right: 30%;"><a href="vtd.php">Back</a></p>            
</div>
