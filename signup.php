...
if(isset($_POST['btn_fetch_data'])) { $_SESSION['post'] = $_POST; }
...
if (isset($_POST['btn_signup'])) {
    ...
    if ($otp == $otp_db) {
        if ($password === $re_password) {
            ...
            $register_user->prepare("insert into pass_master (`EMP_NO`, `pswd`, `auth_code`, `creared_on`) values(:emp_no, :pswd, :auth_code, :created_on)");
            $register_user->bind(':emp_no', $emp_no);
            $register_user->bind(':pswd', $password_to_store);
            $register_user->bind(':auth_code', $auth_code);
            $register_user->bind(':created_on', $date_today);
                                ...
                                if (strlen($phone) == 10) {
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <form action="" method="post" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                <small>Did't get the otp Please</small>
                                                <a href="signup.php" class="btn btn-success" btn_fetch_data>Click hear to restart</a>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input type="submit" class="form-control btn-success" name="btn_signup" value="Signup" >
                                            </div>
                                        </form>
                                    </div>
                                    <?php
