...
$url = 'https://vspthrift.com/web_app_ver01/loan_certi.php?emp_no=' . $user . '&auth=' . $auth . '&loan_no=' . $loan_no . '&type=pdf';
...
$file_name = $user . '_long_term_loan_stmt_' . $loan_no . '.pdf';


file_put_contents('reports/' . $file_name, $output);

header("location:loan_certi.php?emp_no=$user&auth=$auth&loan_no=$loan_no&file=$file_name");
