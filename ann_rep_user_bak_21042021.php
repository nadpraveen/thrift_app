<html>
    ...
    <body>
        ...
        foreach ($statement as $state) {
            ...
            <table class="info" style="width: 650px; margin: auto; padding: 2px; border: none">
                <tr>
                    ...
                    <td>GL.NO : <?php echo $state['GL_NO'] ?></td>
            ...
            <table class=" table table-bordered table-condensed" style="width: 650px; margin: auto;">
                ...
                <tr>
                    <td colspan="6" class="lable">Surity 1:<?php echo $state['LO_S1'] ?></td>

                </tr>
                <tr>
                    <td colspan="6" class="lable">Surity 2:<?php echo $state['LO_S2'] ?></td>

                </tr>
                <tr>
                    <td colspan="6" class="lable">Surity 3: <?php echo $state['LO_S3'] ?></td>
            ...
            <table class=" table table-bordered table-condensed" class="sloan_info" style="width: 650px; margin: auto; ">
                ...
                <tr>
                    <td colspan="6" class="lable">Surity 1:<?php echo $state['EDLO_S1'] ?></td>

                </tr>
                <tr>
                    <td colspan="6" class="lable">Surity 2 : <?php echo $state['EDLO_S2'] ?></td>
        ...
        <table class="table table-bordered table-condensed" style="width: 650px; margin: auto; padding: 2px; border: 1px solid">
            ...
            <?php
            $get_trans_query = "SELECT * FROM thrift.th_members_trans_data where EMP_NO = $user and TRANS_DATE > '$from_date' and TRANS_DATE < '$end_date' order by TRANS_DATE ASC";
            ...
            foreach ($trans as $trans) {
                ...
                <tr>
                    ...
                    <td><?php echo $trans['TD_RCPT'] != NULL ? round($trans['TD_RCPT']) : '' ?> </td>
                    <td><?php echo $trans['TD_PYMT'] != NULL ? round($trans['TD_PYMT']) : '' ?></td>

                    <td><?php echo $trans['VTD_RCPT'] != NULL ? round($trans['VTD_RCPT']) : '' ?> </td>
                    <td><?php echo $trans['VTD_PYMT'] != NULL ? round($trans['VTD_PYMT']) : '' ?></td>

                    <td><?php echo $trans['LO_PRL_REC'] != NULL ? round($trans['LO_PRL_REC']) : '' ?> </td>
                    <td><?php echo $trans['LO_INT_REC'] != NULL ? round($trans['LO_INT_REC']) : '' ?></td>
                    <td><?php echo $trans['NEW_LOAN_PYMT'] != NULL ? round($trans['NEW_LOAN_PYMT']) : '' ?></td>

                    <td><?php echo $trans['ELO_PRL_REC'] != NULL ? round($trans['ELO_PRL_REC']) : '' ?></td>
                    <td><?php echo $trans['ELO_INT_REC'] != NULL ? round($trans['ELO_INT_REC']) : '' ?></td> 
                    <td><?php echo $trans['NEW_EDL_PYMT'] != NULL ? round($trans['NEW_EDL_PYMT']) : '' ?></td>
                </tr>
                <?php
            }
            ?>
