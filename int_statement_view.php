...
<table style="width: 650px; margin: auto; padding: 2px">
    <tr >
        <td width="7%"><img src="data:image/png;base64, <?php echo $logo ?>" width="80" height="100" alt="logo" /></td>
    ...
    <tr>
        <td colspan="4">
            <p align="right">Date : <?php echo $date ?> </p>
        </td>
    </tr>
</table>
<table style="width: 650px; margin: auto; padding: 2px">
...
<div id="click">
    <span align="right" style="margin-left: 30%;
          ...
          <span align="left"><a href="landing_block.php" id="printing">close</a></span>
</div>