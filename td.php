...
if ($app_status == 'aplied') {
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="alert alert-info">
                <span align="center">you have applaied for Withdrawal of Rs.<?php echo $app_amount ?>/-  on <?php echo $reg_date ?></span>
            </div>
        </div>
    </div>
    <?php
    ...
    <div class = "row">
        <div class = "col-md-6 col-md-offset-3">
            <div class = "alert alert-info">
                <span align="center">You are Eligible for Withdrawal Rs.<?php echo round_to_hundred($elg_amt); ?></span>
            </div>
        </div>
    </div>
    <?php
